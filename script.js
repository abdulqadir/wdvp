...
var p1 = dumbbell('hdi', 'health', 'education');
...
var s;
s = plot('hdi', 'political stability & absence of violence');
s.draw(d3.select('#s1'));
s = plot('hdi', 'government effectiveness');
s.draw(d3.select('#s2'));
s = plot('hdi', 'regulatory quality');
s.draw(d3.select('#s3'));
s = plot('hdi', 'rule of law');
s.draw(d3.select('#s4'));
